...
public class cls_tbl_R_HLA_002_Detalle : clsconexion
{
    string tabla = "tbl_R_HLA_002_Detalle";
	...
	public cls_tbl_R_HLA_002_Detalle(int idCodigoenDetalle, int codigoGeneradoEnHead,
