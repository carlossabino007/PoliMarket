...
public class cls_HLA_007: clsconexion
{
    string tabla = "tblR_HLA_007";
	...
	public cls_HLA_007(int idHLA_007, int r_hla_007_tipoAnalisis, int r_hla_007_NumeroMuestra, int r_hla_007_TipoMuestraParte1,
      ...
      public void agregar()
    {
      ...
      public bool ExistePorElCodigodeCasoSolamente(int valor)
      {
          conectar(tabla);
          DataRow fila;
          int x = Data.Tables[tabla].Rows.Count - 1;
          ...
          {
              fila = Data.Tables[tabla].Rows[i];
              if (int.Parse(fila["r_hla_007_NumeroMuestra"].ToString()) == valor)
              {
                      IdHLA_007 = int.Parse(fila["idHLA_007"].ToString());
                      R_hla_007_tipoAnalisis = int.Parse(fila["r_hla_007_tipoAnalisis"].ToString());
                      R_hla_007_NumeroMuestra = int.Parse(fila["r_hla_007_NumeroMuestra"].ToString());
