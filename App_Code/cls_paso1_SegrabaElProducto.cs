...
public class cls_paso1_SegrabaElProducto : clsconexion
{
	...
	public cls_paso1_SegrabaElProducto(int producto_Codigo, int producto_CodMarca, int producto_Presentacion, int producto_Clasificacion,
        ...
        string producto_UsuarioString, int producto_Area, int idProducto)
	{
        // int
    ...
    public bool existePorIdSolamente(int ID)
    {
        conectar(tabla);
        DataRow fila;
        int x = Data.Tables[tabla].Rows.Count - 1;
        ...
        {
            fila = Data.Tables[tabla].Rows[i];
            if ((int.Parse(fila["idProducto"].ToString()) == ID))
            {
                Producto_Descripcion = fila["producto_Descripcion"].ToString();
                Producto_ModoDeConsumo = fila["producto_ModoDeConsumo"].ToString();
                IdProducto = int.Parse(fila["idProducto"].ToString());
    ...
    public bool actualizarporIDSolamente_Descripcion(int id)
    {
        conectar(tabla);
        DataRow fila;   // es un nuevo  registro Fila de datos
        int x = Data.Tables[tabla].Rows.Count - 1;
    ...
    public bool actualizarporIDSolamente_ModoConsumo(int id)
    {
        conectar(tabla);
        DataRow fila;   // es un nuevo  registro Fila de datos
        int x = Data.Tables[tabla].Rows.Count - 1;
